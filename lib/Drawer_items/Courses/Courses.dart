...
class _CoursesState extends State<Courses> {
  late String text;
  final List<String> course_name=["Net Core Full Stack Internship","MERN Full Stack Internship",
  ...
  final List<Widget> courses=[Dotnet(),Mern(),Mean(),Flutter(),Ionic(),Website_designing(),Ui_ux()];
      ...
      home: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
              fit: BoxFit.cover,
              image: AssetImage("images/courses/snowpark-home-slider-background.jpg")
          ),
        ),
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // course_widget(course_name: course_name, courses: courses)
                  Container(
                    height: h/2,
                    width: w,
                              ...
                              itemBuilder: (context,index){
                                ...
                                return
                                  MaterialButton(
                                    ...
                                    onPressed: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => courses1[index]));
                                    },
                                  );
                              }
                          ),
            ...
            //               ),
            //             ),
            //             // Material_button_course("Data Science & AI"),
            //             // Material_button_course("Data Analytics"),
            //             // Material_button_course("Digital Marketing Expert"),
            //             // Material_button_course("Microsoft Power BI"),
            //
            //           ],
            //         ),
            //       ),
